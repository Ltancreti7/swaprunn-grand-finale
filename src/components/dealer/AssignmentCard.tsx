...
import { Star, Phone, MapPin, User, Car, Calendar, UserCircle, ChevronDown } from "lucide-react";
...
export const AssignmentCard = ({ assignment, currentUserId }: AssignmentCardProps) => {
              ...
              <div className="flex-1 space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs text-white/70">
                    {format(new Date(hasStarted ? assignment.started_at! : assignment.accepted_at), 'MMM d, yyyy • h:mm a')}
                  </p>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-white/80 font-semibold">{driver.name}</span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-0.5">
                    <h5 className="font-bold text-sm text-white">{driver.name}</h5>
                  ...
                  {driver.phone && (
                    <a href={`tel:${driver.phone}`} className="text-xs text-white/50 hover:text-[#E11900] transition-colors">
                      {driver.phone}
                    </a>
                  )}
                </div>
