...
import { MessageSquare, Clock, AlertTriangle, ThumbsUp, Navigation, Phone } from 'lucide-react';
...
const MESSAGE_TEMPLATES = [
  {
    ...
    title: 'On My Way',
    icon: Navigation,
    message: 'Hi! I\'m your SwapRunn driver and I\'m on my way to pick up your vehicle. I should arrive in about 15 minutes. Thanks!',
    color: 'text-blue-600'
  },
  {
    id: 'arrived',
    title: 'I\'ve Arrived',
    icon: ThumbsUp,
    message: 'I\'ve arrived at the pickup location. Please let me know where I can find the vehicle and keys. Thanks!',
  ...
  },
  {
    ...
    title: 'Running Late',
    icon: Clock,
    message: 'I\'m running about 10-15 minutes behind schedule due to traffic. I apologize for the delay and will be there shortly.',
  ...
  },
  {
    ...
    title: 'Report Issue',
    icon: AlertTriangle,
    message: 'I\'m experiencing an issue with the pickup. Could you please give me a call when you have a moment? Thanks.',
    color: 'text-red-600'
  },
  {
    id: 'delivered',
    title: 'Delivered',
    icon: ThumbsUp,
    message: 'Your vehicle has been safely delivered to the destination. Thank you for choosing SwapRunn!',
    color: 'text-green-600'
  }
];
...
export function QuickActionTemplates({ jobId, customerPhone, onSendMessage }: QuickActionTemplatesProps) {
