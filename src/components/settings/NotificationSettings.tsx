      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          {userProfile?.user_type === 'driver' ? (
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <Label htmlFor="new-jobs" className="text-sm">New job opportunities</Label>
                <Switch id="new-jobs" defaultChecked />
              </div>
              <div className="flex items-center justify-between">
                <Label htmlFor="job-updates" className="text-sm">Job status updates</Label>
              ...
              <div className="flex items-center justify-between">
                <Label htmlFor="payments" className="text-sm">Payment notifications</Label>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <Label htmlFor="job-responses" className="text-sm">Driver responses to jobs</Label>
                <Switch id="job-responses" defaultChecked />
              </div>
              <div className="flex items-center justify-between">
                <Label htmlFor="delivery-updates" className="text-sm">Delivery progress updates</Label>
