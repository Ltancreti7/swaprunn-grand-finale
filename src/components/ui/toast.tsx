...
>(({ className, ...props }, ref) => {
  ...
  const style = isSmall
    ? {
        top: `calc(${headerOffset}px + env(safe-area-inset-top))`,
        maxHeight: `calc(100vh - ${headerOffset}px - env(safe-area-inset-top))`,
      }
    : undefined;
  ...
  return (
    <ToastPrimitives.Viewport
      ref={ref}
      className={cn(
        "fixed z-[120] flex w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]",
        className,
      )}
      style={style}
      {...props}
