      ...
      <section className="relative z-10 py-20">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl lg:text-6xl font-bold text-white mb-6">About SwapRunn</h1>
            
            <div className="space-y-8 mb-12">
              <p className="text-xl text-white/80 max-w-3xl mx-auto">
                Join thousands of dealers who trust SwapRunn for their delivery needs. Our platform streamlines operations 
                while providing unmatched transparency and reliability.
              </p>
              ...
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-3xl p-8 text-left">
                ...
                <ul className="space-y-4 text-white/80">
                  <li className="flex items-start gap-3">
                    ...
                    <span><strong className="text-white">Trusted Network:</strong> All drivers are background-checked and verified</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#E11900] rounded-full mt-3 flex-shrink-0"></div>
                    <span><strong className="text-white">Real-time Updates:</strong> GPS tracking and instant notifications keep everyone informed</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#E11900] rounded-full mt-3 flex-shrink-0"></div>
                    <span><strong className="text-white">Seamless Integration:</strong> Easy to use platform that fits into your existing workflow</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#E11900] rounded-full mt-3 flex-shrink-0"></div>
                    <span><strong className="text-white">24/7 Support:</strong> Real humans available when you need help</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild size="lg" className="bg-[#E11900] hover:bg-[#E11900]/90 text-white h-12 px-8 rounded-2xl">
                <Link to="/dealer/auth">
                  Get Started Today
