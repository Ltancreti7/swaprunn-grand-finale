  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!user || !userProfile?.dealer_id) {
      toast({
        ...
        description:
          "Please sign in with a dealer account before requesting a driver.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      try {
        await supabase.functions.invoke("notify-drivers-new-job", {
          body: {
            ...
            pickup_address:
              job.pickup_address ?? addressToString(pickupAddress),
            delivery_address:
              job.delivery_address ?? addressToString(deliveryAddress),
      ...
      toast({
        ...
        description:
          "Your delivery request has been submitted and drivers have been notified.",
      });
                    ...
                    <div className="space-y-8">
                      <div className="text-center mb-8">
                        ...
                        <p className="text-white/70 text-lg">
                          Tell us about the vehicle that needs delivery
                        </p>
                      </div>
                        ...
                        <VINScanner
                          onVINScanned={(vehicleInfo) => {
                            ...
                            if (vehicleInfo.transmission) {
                              const trans =
                                vehicleInfo.transmission.toLowerCase();
                              if (
                                trans.includes("automatic") ||
                                trans.includes("auto")
                              ) {
                  ...
                  {currentStep === 2 && (
                    <div className="space-y-8">
                      <div className="text-center mb-8">
                        ...
                        <p className="text-white/70 text-lg">
                          Is there a trade-in vehicle the driver will need to
                          drive back?
                        </p>
                      </div>
                          ...
                          <div className="space-y-8 bg-white/5 rounded-xl p-8 border border-white/10">
                            <div className="text-center mb-6">
                              ...
                              <p className="text-white/60">
                                The driver will drive this vehicle back from the
                                delivery location
                              </p>
                            </div>
                              ...
                              <div className="flex items-end">
                                <div className="bg-amber-500/20 border border-amber-500/30 rounded-lg p-4 w-full">
                                  <p className="text-amber-200 text-sm">
                                    <strong>Note:</strong> We'll match you with
                                    drivers who can operate this transmission
                                    type.
                                  </p>
                                </div>
                              </div>
                        ...
                        <div className="max-w-2xl mx-auto">
                          <div className="bg-green-500/20 border border-green-500/30 rounded-xl p-6 text-center">
                            <p className="text-green-200 text-lg">
                              <strong>One-way delivery:</strong> The driver will
                              only deliver the vehicle and return via other
                              means.
                            </p>
                          </div>
                        </div>
                  ...
                  {currentStep === 5 && (
                    <div className="space-y-6">
                      <div className="text-center mb-6">
                        ...
                        <p className="text-white/60">
                          When do you need this delivery completed?
                        </p>
                      </div>
