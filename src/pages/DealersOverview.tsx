    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 pt-6 sm:pt-12 pb-8 sm:pb-12">
        ...
        <Button
          ...
          variant="ghost"
          size="sm"
          className="text-white/80 hover:text-white hover:bg-white/10 mb-6 sm:mb-8 text-sm sm:text-base"
        >
          <Link to="/">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-black tracking-tight text-white mb-4 sm:mb-6 leading-tight px-2">
            ...
            <span className="text-[#E11900]">Logistics</span>
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed mb-6 sm:mb-8 px-4">
            Real-time tracking, faster swaps, and significant cost savings — all
            in one platform built for modern dealerships.
          </p>
          <div className="flex flex-col gap-3 sm:gap-4 sm:flex-row justify-center px-4">
            <Link to="/dealer/auth" className="w-full sm:w-auto">
              <Button
                size="lg"
                className="w-full sm:w-auto bg-[#E11900] hover:bg-[#E11900]/90 text-white font-bold py-4 px-6 sm:px-8 rounded-xl text-base sm:text-lg shadow-lg hover:shadow-xl transition-all duration-300"
              >
                Get Started Now
            ...
            <Link to="/how-it-works" className="w-full sm:w-auto">
              <Button
                variant="outline"
                size="lg"
                className="w-full sm:w-auto border-white/40 text-white hover:bg-white/10 font-bold py-4 px-6 sm:px-8 rounded-xl text-base sm:text-lg shadow-lg hover:shadow-xl transition-all duration-300"
              >
                See How It Works
              </Button>
            </Link>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-12 sm:mb-16 lg:mb-20 px-2 sm:px-0">
          <Card className="bg-gray-900/80 backdrop-blur-sm border-gray-700/50 shadow-2xl rounded-2xl overflow-hidden group hover:scale-105 transition-transform duration-300">
            <CardContent className="p-6 sm:p-8">
              ...
              <p className="text-white/80 text-base sm:text-lg leading-relaxed">
                Monitor every delivery with live GPS tracking. Know exactly
                where your vehicles are at all times.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gray-900/80 backdrop-blur-sm border-gray-700/50 shadow-2xl rounded-2xl overflow-hidden group hover:scale-105 transition-transform duration-300">
            <CardContent className="p-6 sm:p-8">
              ...
              <p className="text-white/80 text-base sm:text-lg leading-relaxed">
                Reduce delivery time by up to 60% with our optimized driver
                network and instant dispatch system.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gray-900/80 backdrop-blur-sm border-gray-700/50 shadow-2xl rounded-2xl overflow-hidden group hover:scale-105 transition-transform duration-300 sm:col-span-2 lg:col-span-1">
            <CardContent className="p-6 sm:p-8">
              ...
              <p className="text-white/80 text-base sm:text-lg leading-relaxed">
                Save up to 40% on logistics costs compared to traditional
                methods. Pay per swap with transparent pricing.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="mb-12 sm:mb-16 lg:mb-20">
          <div className="text-center mb-8 sm:mb-12 px-4">
            ...
            <p className="text-base sm:text-lg text-white/70 max-w-2xl mx-auto">
              Real screenshots from our platform showing the actual dealer
              experience
            </p>
          </div>
              ...
              <CardContent className="p-0">
                <div className="relative">
                  ...
                  <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 right-3 sm:right-4">
                    ...
                    <p className="text-white/80 text-xs sm:text-sm">
                      Streamlined 5-step vehicle delivery requests
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-0">
                <div className="relative">
                  ...
                  <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 right-3 sm:right-4">
                    ...
                    <p className="text-white/80 text-xs sm:text-sm">
                      Native mobile apps for dealers and drivers
                    </p>
                  </div>
                </div>
              </CardContent>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/70 max-w-2xl mx-auto">
              Manage all your deliveries, track drivers, and analyze performance
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 px-4 sm:px-0">
            <Card className="bg-gray-900/80 backdrop-blur-sm border-gray-700/50 shadow-2xl rounded-2xl sm:col-span-2 lg:col-span-1">
              <CardHeader className="pb-3 sm:pb-4 p-4 sm:p-6">
                ...
                <div className="text-3xl sm:text-4xl font-bold text-[#E11900] mt-2">
                  $99
          ...
          <Card className="bg-gradient-to-r from-[#E11900]/20 to-[#E11900]/10 backdrop-blur-sm border-[#E11900]/30 shadow-2xl rounded-2xl max-w-4xl mx-auto">
            <CardContent className="p-6 sm:p-8 lg:p-12">
              ...
              <p className="text-lg sm:text-xl text-white/80 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed">
                Join hundreds of dealerships already saving time and money with
                SwapRunn's professional vehicle delivery platform.
              </p>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              <div className="text-center md:text-left">
                ...
                <span className="text-white/30 text-sm ml-3">
                  Professional Vehicle Delivery Platform
                </span>
              </div>
