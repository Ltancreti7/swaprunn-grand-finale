...
import { ArrowRight, Check, Clock, MapPin, User, Car, Phone, Calendar, ArrowLeft } from "lucide-react";
  ...
  const dealerSteps = [
    {
      ...
      description: "Access your dedicated dealer dashboard with secure authentication and personalized profile management",
      features: [
    ...
    },
    {
      ...
      description: "Our streamlined 4-step process makes requesting professional vehicle delivery quick and easy",
      features: [
    ...
    },
    {
      ...
      description: "Monitor all your delivery requests from your comprehensive dealer dashboard",
      features: [
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 pt-12 pb-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed">
            Streamline your vehicle deliveries with our simple, professional platform
          </p>
        </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/70 max-w-2xl mx-auto">
              Get your vehicles delivered quickly and professionally with just a few clicks
            </p>
          </div>

          <div className="space-y-16">
            {dealerSteps.map((step, index) => (
              <div key={step.step} className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-12 lg:gap-16`}>
                {/* Content */}
                              ...
                              {step.step === 1 && (
                                <>
                                  <div className="text-center mb-8">
                                    <img src="/swaprunn-logo-2025.png" alt="SwapRunn" className="h-8 mx-auto mb-6 opacity-90" />
                                    <h2 className="text-2xl font-bold text-white mb-2">Dealer <span className="text-[#E11900]">Sign In</span></h2>
                                    <p className="text-gray-400 text-sm">Access the Dealer Portal</p>
                                  </div>
                                  <div className="space-y-4 flex-1">
                                    <div>
                                      <label className="text-white text-sm mb-2 block">Email Address</label>
                                      <div className="bg-gray-700 rounded-lg p-3 text-white">ltancreti7@gmail.com</div>
                                    </div>
                                    <div>
                                      <label className="text-white text-sm mb-2 block">Password</label>
                                      <div className="bg-gray-700 rounded-lg p-3 text-white">•••••••••••</div>
                                    </div>
                                    ...
                                    <p className="text-sm text-white/60 italic">Your email and password will be saved for faster login next time</p>
                                  </div>
                              ...
                              {step.step === 2 && (
                                <>
                                  <div className="text-center mb-4">
                                    <h2 className="text-xl font-bold text-white mb-1">Request a Driver</h2>
                                    <p className="text-gray-400 text-sm">Step 1 of 4</p>
                                  </div>
                                  <div className="flex justify-between mb-6">
                                    {[
                                      { label: 'Vehicle', icon: Car, active: true },
                                      { label: 'Address', icon: MapPin, active: false },
                                      { label: 'Customer', icon: User, active: false },
                                      { label: 'Details', icon: Clock, active: false }
                                    ].map((item, i) => (
                                      <div key={i} className={`text-center ${item.active ? 'text-[#E11900]' : 'text-gray-500'}`}>
                                        <div className={`w-8 h-8 rounded-full mx-auto mb-1 flex items-center justify-center ${item.active ? 'bg-[#E11900]' : 'bg-gray-600'}`}>
                                  ...
                                  <div className="space-y-4 flex-1">
                                    <div>
                                      <h3 className="text-white text-lg font-semibold mb-4 text-center">What vehicle needs delivery?</h3>
                                      <p className="text-gray-400 text-sm text-center mb-4">Tell us about the vehicle</p>
                                    </div>
                                    ...
                                    <input className="w-full bg-gray-700 text-white p-3 rounded-lg border border-gray-600" placeholder="VIN (Optional)" value="123456789109876" readOnly />
                                  </div>
                              ...
                              {step.step === 3 && (
                                <>
                                  <div className="text-center mb-6">
                                    ...
                                    <p className="text-gray-400 text-sm">Manage your deliveries and track driver assignments</p>
                                  </div>
                                  <div className="flex justify-between mb-6 bg-gray-800 rounded-lg p-1">
                                    {[
                                      { label: 'Profile', active: true, count: null },
                                      { label: 'Pending', active: false, count: 2 },
                                      { label: 'Assigned', active: false, count: null },
                                      { label: 'Done', active: false, count: null }
                                    ].map((tab, i) => (
                                      <div key={i} className={`px-3 py-2 rounded-md text-sm font-medium relative ${tab.active ? 'bg-[#E11900] text-white' : 'text-gray-400'}`}>
                                        {tab.label}
                                        {tab.count && <span className="ml-1 bg-[#E11900] text-white text-xs rounded-full px-1">{tab.count}</span>}
                                      </div>
                                    ))}
                                  </div>
                                  ...
                                  <div className="bg-gray-800 rounded-lg p-4 text-center">
                                    ...
                                    <h3 className="text-white font-bold text-lg">John Smith</h3>
                                    <p className="text-gray-400 text-sm">Smith Toyota</p>
                                    <p className="text-gray-400 text-sm">Sales Consultant</p>
                                    <p className="text-gray-500 text-xs mt-2">📅 Member since 9/28/2025</p>
                                  </div>
                                </>
                              )}
                            </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/70 max-w-2xl mx-auto">
              Real screenshots from our platform showing the actual user experience
            </p>
          </div>
                ...
                <div className="relative">
                  <div className="w-full h-48 bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-white font-medium">Mobile App Interface</p>
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    ...
                    <p className="text-white/80 text-sm">Native iOS and Android applications</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gray-900/80 backdrop-blur-sm border-gray-700/50 shadow-2xl rounded-2xl overflow-hidden group hover:scale-105 transition-transform duration-300">
              <CardContent className="p-0">
                <div className="relative">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                  <div className="absolute bottom-4 left-4 right-4">
                    <h3 className="text-white font-bold text-lg mb-1">Driver Interface</h3>
                    <p className="text-white/80 text-sm">Job acceptance and tracking system</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="bg-gradient-to-r from-[#E11900]/20 to-[#E11900]/10 backdrop-blur-sm border-[#E11900]/30 shadow-2xl rounded-2xl max-w-4xl mx-auto">
            <CardContent className="p-12">
              ...
              <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
                Join hundreds of dealerships using SwapRunn for faster, more reliable vehicle delivery services.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link to="/driver/auth">
                  <Button variant="outline" className="border-white/40 text-white hover:bg-white/10 font-bold py-4 px-8 rounded-xl text-lg shadow-lg hover:shadow-xl transition-all duration-300">
                    Join as Driver
                  </Button>
                </Link>
              </div>
