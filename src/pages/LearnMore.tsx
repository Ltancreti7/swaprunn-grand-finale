          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            <div>
              ...
              <p className="text-lg text-white/80 mb-8">
                Discover the powerful features that make SwapRunn the preferred choice for dealership logistics.
              </p>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">Live GPS tracking with instant updates on job progress. Both dealers and customers receive real-time notifications.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <CheckCircle className="h-6 w-6 text-[#E11900] flex-shrink-0 mt-1" />
                  <div>
                    ...
                    <p className="text-white/70">Smart matching to verified drivers in your area. Our algorithm finds the best available driver within minutes.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <CheckCircle className="h-6 w-6 text-[#E11900] flex-shrink-0 mt-1" />
                  <div>
                    ...
                    <p className="text-white/70">Comprehensive insights into delivery performance, driver ratings, and operational efficiency.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <CheckCircle className="h-6 w-6 text-[#E11900] flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-semibold text-white mb-1">Proof of delivery</h3>
                    <p className="text-white/70">Photo documentation, digital signatures, and delivery confirmations for complete transparency.</p>
                  </div>
                </div>
              </div>
