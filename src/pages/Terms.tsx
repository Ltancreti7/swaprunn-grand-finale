...
const Terms = () => {
  return (
    <div className="min-h-screen relative" style={{
      ...
      <meta name="description" content="Terms of service for SwapRunn's auto delivery and swap management platform for dealers and drivers." />
        ...
        <div className="relative z-10 px-4 pt-24 py-12">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4 text-white/90">
              By accessing and using SwapRunn's services, you accept and agree to be bound by the terms 
          ...
          <section className="mb-8">
            ...
            <p className="mb-4 text-white/90">
              SwapRunn provides a platform for auto dealers to manage vehicle deliveries and swaps, 
              connecting them with qualified drivers for transportation services.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4 text-white/90">
              ...
              as required by law. We reserve the right to modify pricing with 30 days notice.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-white">Driver Requirements</h2>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4 text-white/90">
              SwapRunn shall not be liable for any indirect, incidental, special, consequential, 
              ...
              <section className="mb-8">
                ...
                <p className="text-white/90">
                  ...
                  <a href="mailto:legal@swaprunn.com" className="text-[#DC2626] hover:underline hover:text-red-400">
                    legal@swaprunn.com
                  </a>
                </p>
              </section>
