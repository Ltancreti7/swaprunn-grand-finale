...
const Track = () => {
      ...
      <div className="min-h-screen bg-surface-secondary flex items-center justify-center p-4">
        <Card className="max-w-md w-full">
          <CardContent className="pt-6 text-center">
            ...
            <h1 className="text-xl font-semibold text-text-primary mb-2">Loading...</h1>
            <p className="text-text-secondary">Fetching your tracking information...</p>
          </CardContent>
        </Card>
      </div>
    );
  ...
  const steps = [
    { number: 1, title: 'Job Posted', description: 'Your delivery request has been created', icon: Package },
    { number: 2, title: 'Driver Assigned', description: 'A driver has accepted your job', icon: Truck },
    { number: 3, title: 'In Transit', description: 'Driver is working on your delivery', icon: Clock },
    { number: 4, title: 'Completed', description: 'Your delivery has been completed', icon: CheckCircle },
  ];
      ...
      <div className="relative z-10 container mx-auto px-4 pt-24 py-8">
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-2">
            <h1 className="text-3xl font-bold text-text-primary">Track Your {job.type}</h1>
            <p className="text-text-secondary">Tracking ID: {job.track_token}</p>
          </div>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4">
                <div className="p-4 bg-surface-secondary rounded-lg">
                  <div className="font-semibold text-text-primary mb-1">From</div>
                  <div className="text-text-secondary">{job.pickup_address}</div>
                </div>
                <div className="p-4 bg-surface-secondary rounded-lg">
                  <div className="font-semibold text-text-primary mb-1">To</div>
                  <div className="text-text-secondary">{job.delivery_address}</div>
                </div>
              </div>

              <div className="grid grid-cols-2 gap-4">
                <div>
                  <div className="font-semibold text-text-primary">Customer</div>
              ...
              {job.vin && (
                <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="font-semibold text-blue-800 mb-1">Vehicle Information</div>
                  <div className="text-blue-700">
                    {job.year} {job.make} {job.model}
                  </div>
                  <div className="text-blue-600 text-sm font-mono">VIN: {job.vin}</div>
                </div>
              )}

              {job.notes && (
                <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="font-semibold text-blue-800 mb-1">Special Instructions</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <div className="font-semibold text-text-primary">{job.driver_name}</div>
                    <div className="text-text-secondary text-sm">Professional Driver</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <CardContent className="pt-6">
              ...
              {job.status === 'assigned' && (
                <div className="text-center text-blue-600">
                  ...
                  <p>Your driver is preparing to start your {job.type.toLowerCase()}.</p>
                </div>
              )}
              ...
              {job.status === 'completed' && (
                <div className="text-center text-green-600">
                  ...
                  <p>Your {job.type.toLowerCase()} has been completed successfully!</p>
                </div>
              )}
            </CardContent>
          </Card>
            ...
            <CardContent>
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-text-primary font-medium">(555) SWAPRUNN</span>
                </div>
