...
if (!SUPABASE_URL) {
  console.error('Missing SUPABASE_URL in environment. Set SUPABASE_URL in supabase/.env.local or your shell env.')
  process.exit(2)
}

if (!SUPABASE_ANON_KEY) {
  console.error('Missing SUPABASE_ANON_KEY (or SUPABASE_KEY) in environment. Set SUPABASE_ANON_KEY in supabase/.env.local or your shell env.')
  process.exit(2)
}
